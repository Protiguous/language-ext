...
namespace LanguageExt
{
        ...
        where OrdK : struct, Ord<K>
    {
        ...
        private static KeyValuePair<K, V> ToKeyValuePair((K Key, V Value) kv) =>
    ...
    [Serializable]
    internal class MapItem<K, V> :
        ISerializable,
        IMapItem<K, V>
    {
        internal static readonly MapItem<K, V> Empty = new MapItem<K, V>(0, 0, (default, default), null, null);
        ...
        /// </summary>
        private MapItem(SerializationInfo info, StreamingContext context)
        {
