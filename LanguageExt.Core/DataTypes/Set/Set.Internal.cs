...
namespace LanguageExt
{
    internal static class SetModule
    {
        ...
        {
            private readonly SetItem<K> map;
    ...
    {
        private readonly SetItem<A> set;
    ...
    {
        public static readonly SetItem<K> Empty = new SetItem<K>(0, 0, default, null, null);
