...
namespace LanguageExt
{
    ...
    public static class Stack
    {
        ...
        /// <returns>An enumerable with all duplicate values removed</returns>
        [Pure]
        public static IEnumerable<T> distinct<T, K>(Stck<T> stack, Func<T, K> keySelector, Option<Func<K, K, bool>> compare = default) =>
...
public static class StackExtensions
{
    ...
    /// <returns>An enumerable with all duplicate values removed</returns>
    [Pure]
    public static IEnumerable<T> Distinct<T, K>(this Stck<T> stack, Func<T, K> keySelector, Option<Func<K, K, bool>> compare = default) =>
