...
namespace LanguageExt
{
    ...
    public struct Validation<FAIL, SUCCESS> :
        ...
        ISerializable
    {
        private readonly Seq<FAIL> fail;
        ...
        private Validation(Seq<FAIL> fail)
        {
        ...
        private IEnumerable<ValidationData<FAIL, SUCCESS>> Enum()
        {
    ...
    public struct ValidationContext<FAIL, SUCCESS, Ret>
    {
        ...
        private readonly Validation<FAIL, SUCCESS> validation;
